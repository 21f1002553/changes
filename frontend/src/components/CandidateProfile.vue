            ...
            <div v-else-if="resumes.length > 0" class="resume-list">
              ...
              >
                ...
                <div class="resume-info">
                  <h4>{{ resume.filename || resume.original_filename }}</h4>
                  <p class="resume-meta">
        ...
        <div class="profile-right">
          ...
          <div class="info-card">
            ...
            <div class="experience-list">
              <div 
                v-for="(exp, index) in editData.experience" 
                :key="index" 
          ...
          <div class="info-card">
            ...
            <div class="education-list">
              <div 
                v-for="(edu, index) in editData.education" 
                :key="index" 
          ...
          <div class="info-card">
            ...
            <div class="form-grid">
              <div class="form-group">
                ...
                <input 
                  v-model="editData.preferences.jobTitle" 
                  type="text" 
                  :disabled="!isEditMode"
              ...
              <div class="form-group">
                ...
                <input 
                  v-model="editData.preferences.salary" 
                  type="text" 
                  :disabled="!isEditMode"
              ...
              <div class="form-group">
                ...
                <input 
                  v-model="editData.preferences.location" 
                  type="text" 
                  :disabled="!isEditMode"
              ...
              <div class="form-group">
                ...
                <select 
                  v-model="editData.preferences.employmentType" 
                  :disabled="!isEditMode"
                >
...
const deleteResume = async (resumeId) => {
  ...
  try {
    await axios.delete(`/api/files/${resumeId}`, {
      headers: { Authorization: `Bearer ${getAuthToken()}` }
    })
