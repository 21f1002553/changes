    ...
    <div class="modal-container" @click.stop>
      ...
      <div class="modal-body">
        ...
        <form @submit.prevent="submitApplication" class="application-form">
          ...
          <div class="form-group">
            ...
            <select id="resume" v-model="formData.resumeId" required :disabled="loading || resumes.length === 0">
              <option value="">-- Select a resume --</option>
              <option :key="resumes.id" :value="resumes.id">
                {{ resumes.filename }}
              </option>
      ...
      <div class="form-group">
        ...
        <textarea id="additionalInfo" v-model="formData.additionalInfo"
          placeholder="Any additional information you'd like to share (certifications, portfolio links, etc.)" rows="4"
      ...
      <div class="form-group">
        ...
        <div class="input-group">
          ...
          <input id="expectedSalary" v-model.number="formData.expectedSalary" type="number" placeholder="50000" min="0"
            :disabled="loading" />
